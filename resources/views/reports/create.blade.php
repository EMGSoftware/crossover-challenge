		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{{ Form::open(['url' => 'reports', 'data-toggle' => 'validator', 'class' => 'form']) }}
						<input type="hidden" id="hdn_items_tests" name="hdn_items_tests"/>
						<div class="row">
							<div class="col-sm-3 form-group">
								{{ Form::label('patients', 'Patient:', $attibutes = ['class' => 'control-label']) }}
								{{ Form::select('patients', $patients, null, $attributes = ["id" => "patients", "class" => "selectpicker show-menu-arrow form-control", "data-live-search" => "true", "data-size" => "4", "required" => "required", "data-error" => "This field is mandatory"]) }}
...
<script type="text/javascript">
	$("#add_test_button").on ("click", function () { add_item ($('#tests'), $('#items_tests'), $('#result').val("")); });
</script>
@stop

		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{{ Form::open(['url' => 'operators', 'data-toggle' => 'validator', 'class' => 'form', 'id' => 'form']) }}
						<div class="row">
						...
						<div class="row">
							<div class="col-sm-12 form-group">
								...
								<div class="input-group">
									{{ Form::text('passcode', $value = null, $attributes = ["class" => "form-control", "id" => "passcode", "required" => "required", "data-error" => "This field is mandatory"]) }}
						...
						<div class="well well-sm">
							<a class="btn btn-primary" href="{{ route('operators.index') }}"><i class="glyphicon glyphicon-backward"></i> Back</a>
...
<script type="text/javascript">
	...
	$("#generate_passcode_button").on ("click", function () { generate_new_code() });
	
	function generate_new_code ()
	{
		$("#passcode").val (Math.random().toString(36).replace(/[^a-z]+/g, '').substr(0, 15));
	}
